            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
                ...
                <h1 className="text-3xl md:text-7xl font-black mb-6 md:mb-10 leading-[1.1] tracking-tighter">
                    <div className="overflow-hidden py-2">
                        <span className="chrome-text block drop-shadow-2xl animate-reveal">Excelência em PPF e Envelopamento de Luxo</span>
                    </div>
                </h1>

                <div className="max-w-2xl mx-auto mb-10 md:mb-16">
                    <p className="text-base md:text-xl text-gray-300 font-light leading-relaxed animate-fade-scale">
                        Onde o cuidado artesanal encontra as tecnologias mais avançadas de PPF e personalização.
                    </p>
                </div>

                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 animate-fade-in">
